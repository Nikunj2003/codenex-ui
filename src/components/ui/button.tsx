...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/88 rounded-lg",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 rounded-lg",
        outline: "border border-border bg-background hover:bg-secondary hover:border-secondary rounded-lg",
        ...
        hero: "bg-foreground text-background hover:bg-foreground/90 rounded-full font-semibold tracking-tight",
        "hero-outline": "border-2 border-foreground/15 text-foreground hover:bg-foreground/5 rounded-full font-medium",
        soft: "bg-primary/8 text-primary hover:bg-primary/14 rounded-lg font-medium",
      },
      size: {
